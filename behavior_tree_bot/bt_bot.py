...
def setup_behavior_tree():
    ...
    close_planet_plan.child_nodes = [close_enemy_planet_attack, close_neutral_planet_attack]
    ...
    root.child_nodes = [defense, close_planet_plan, offensive_plan, spread_sequence, attack.copy()]
